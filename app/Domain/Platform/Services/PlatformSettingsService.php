...
class PlatformSettingsService
{
    ...
    public function defaults(): array
    {
        return [
            ...
            'mail.brevo_key' => '',
            'sms.driver' => 'log',
            'sms.sender_id' => 'ATTENDRLY',
            'sms.api_url' => '',
            'sms.api_key' => '',
            'sms.api_secret' => '',
            'billing.reminders_enabled' => true,
            'billing.trial_reminder_days' => 3,
            'billing.renewal_reminder_days' => 3,
            'billing.invoice_due_reminder_days' => 3,
            'billing.send_invoice_on_issue' => true,
